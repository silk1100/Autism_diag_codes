...
def main():
    ...
    age,_ = df_leftHemi_train.pop('age'), df_leftHemi_train.pop('age')
    sex,_ = df_leftHemi_train.pop('sex'), df_rightHemi_train.pop('sex')

    df_leftHemi_train.to_csv(f'{os.path.join(OUTPUT_DIR_SPLIT,"left_train.csv")}')
    df_rightHemi_train.to_csv(f'{os.path.join(OUTPUT_DIR_SPLIT,"right_train.csv")}')
    df_test_left.to_csv(f'{os.path.join(OUTPUT_DIR_SPLIT,"left_test.csv")}')
    df_test_right.to_csv(f'{os.path.join(OUTPUT_DIR_SPLIT,"right_test.csv")}')
    ...
    df_rightHemi_train_corr.to_csv(os.path.join(OUTPUT_DIR_CORR, 'right_train_noColliniarity.csv'))
    df_leftHemi_train_corr.to_csv(os.path.join(OUTPUT_DIR_CORR, 'left_train_noColliniarity.csv'))
    ...
    dump(obj_left_lsvm, os.path.join(OUTPUT_DIR_FS,"left_svc.joblib"))
    dump(obj_right_lsvm, os.path.join(OUTPUT_DIR_FS,"right_svc.joblib"))
    dump(obj_left_rf, os.path.join(OUTPUT_DIR_FS,"left_rf.joblib"))
    dump(obj_right_rf, os.path.join(OUTPUT_DIR_FS,"right_rf.joblib"))
    ...
    dump(clf_left_lsvc, os.path.join(OUTPUT_DIR_ML,"clf_left_svm.joblib"))
    dump(clf_right_lsvc, os.path.join(OUTPUT_DIR_ML,"clf_right_svm.joblib"))
    dump(clf_left_rf, os.path.join(OUTPUT_DIR_ML,"clf_left_rf.joblib"))
    dump(clf_right_rf, os.path.join(OUTPUT_DIR_ML,"clf_right_rf.joblib"))
