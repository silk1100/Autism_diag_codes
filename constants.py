...
OUTPUT_DIR_ML = './Final_Results_MorphBlock/ML'
OUTPUT_DIR_FS = './Final_Results_MorphBlock/FS'
OUTPUT_DIR_CORR = './Final_Results_MorphBlock/CORR_ANA'
OUTPUT_DIR_SPLIT = './Final_Results_MorphBlock/INITIAL_SPLIT'
OUTPUT_DIR_site_ana = './Final_Results_MorphBlock/site_analysis'
