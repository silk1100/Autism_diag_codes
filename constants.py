...
OUTPUT_DIR_ML = './Final_Results_CombineFeats/ML'
OUTPUT_DIR_FS = './Final_Results_CombineFeats/FS'
OUTPUT_DIR_CORR = './Final_Results_CombineFeats/CORR_ANA'
OUTPUT_DIR_SPLIT = './Final_Results_CombineFeats/INITIAL_SPLIT'
OUTPUT_DIR_site_ana = './Final_Results_CombineFeats/site_analysis'
