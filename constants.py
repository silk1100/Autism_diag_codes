...
OUTPUT_DIR_ML = './Final_Results_DP/ML'
OUTPUT_DIR_FS = './Final_Results_DP/FS'
OUTPUT_DIR_CORR = './Final_Results_DP/CORR_ANA'
OUTPUT_DIR_SPLIT = './Final_Results_DP/INITIAL_SPLIT'
OUTPUT_DIR_site_ana = './Final_Results_DP/site_analysis'
